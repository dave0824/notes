...
![synchronized-codeblock](../asset\juc\synchronized-codeblock.png)
从上面我们可以看出：
...
```
![synchronized-codeblock](../asset\juc\synchronized-method.png)
synchronized 修饰的方法并没有 monitorenter 指令和 monitorexit 指令，取得代之的确实是 ACC_SYNCHRONIZED 标识，该标识指明了该方法是一个同步方法，JVM 通过该 ACC_SYNCHRONIZED 访问标志来辨别一个方法是否声明为同步方法，从而执行相应的同步调用。

### 1.6后sychronized的底层优化
...
![synchronized-codeblock](../asset\juc\lock.png)
...
![synchronized-codeblock](../asset\juc\synchronized.png)
